...
namespace Id3
{
    ...
    public class Mp3Stream : IDisposable
    {
        ...
        {
            get { return ExistingHandlers.Select(handler => new Version(handler.Handler.MajorVersion, handler.Handler.MinorVersion)); }
        }

        public bool HasTags
        {
            get { return ExistingHandlers.Count > 0; }
        }
        #endregion
        ...
        private static readonly RegisteredId3Handlers _registeredHandlers = new RegisteredId3Handlers();

        static Mp3Stream()
        {
            _registeredHandlers.Register<Id3v23Handler>();
            _registeredHandlers.Register<Id3v1Handler>();
            _registeredHandlers.Register<Id3v24Handler>();
            _registeredHandlers.Register<Id3v22Handler>();
        }
